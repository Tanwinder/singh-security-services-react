...
const Footer = props => {
  ...
  <div class="footer-address">
    ...
    <p><span>Singh Security Services</span><br>
      ...
      E-mail: <a href="mailto:info@singhsecurityservices.com">info@singhsecurityservices.com</a></p>
  </div>
  <div class="footer-navbar">
      <h3>More Information</h3>
    <app-nav *ngFor="let nav of navs" [navclass]="nav.navclass" [name]="nav.name" [routerlink]="nav.routerlink"></app-nav>
  </div>
